...
> ${TABLE_DEFINITIONS_DIR}/tdef_tpcds_ext_noauto_${table_name}_fix_1.json

sed -i 's/"fieldDelimiter": ","/"fieldDelimiter": "|"/' ${TABLE_DEFINITIONS_DIR}/tdef_tpcds_ext_noauto_${table_name}_fix_1.json
bq --project_id=${PROJECT_ID} --location=${REGION_1} mk --external_table_definition=${TABLE_DEFINITIONS_DIR}/tdef_tpcds_ext_noauto_${table_name}_fix_1.json ${BQD_TPCDS_EXTERNAL_NOAUTODETECT}.${table_name}_fix_1
